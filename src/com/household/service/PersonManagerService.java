 ...
 * 20.通过租户ID查询租房信息,连表查询（HouseInfo，PersonOwnerInfo，PersonRenterInfo）(输入int，返回List<PersonRenterInfoAll>类）
 * 21.通过租户电话查询租房信息,连表查询（HouseInfo，PersonOwnerInfo，PersonRenterInfo）(输入String，返回List<PersonRenterInfoAll>类）
 ****在每个方法前写备注，明确方法用途
